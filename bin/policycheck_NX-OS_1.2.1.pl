...
$diff1 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_01_NX-OS_AAA"),$config);
...
$diff2 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_02_NX-OS_TACACS"),$config);
...
$diff3 = &ios_config_nested_lines(&open_file("$nxos_policy_dir/policy_03_NX-OS_MGMT_Interface"),$config);
...
$diff4 = &ios_config_nested_lines(&open_file("$nxos_policy_dir/policy_04_NX-OS_MGMT_Routing"),$config);
$output4 = &pass_check($diff4);
$diff4 = &strip_comments($diff4);
print "$date,$timestamp,$file,NX-OS,04 - MGMT Routing,$output4$diff4\n";

# Policy 05 - NX-OS NTP
$diff5 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_05_NX-OS_NTP"),$config);
...
$diff6 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_06_NX-OS_NTPConf"),$config);
...
$diff7 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_07_NX-OS_MGMT_NTP"),$config);
$output7 = &pass_check($diff7);
$diff7 = &strip_comments($diff7);
print "$date,$timestamp,$file,NX-OS,07 - MGMT NTP,$output7$diff7\n";

# Policy 08 - NX-OS DNS
$diff8 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_08_NX-OS_DNS"),$config);
...
$diff9 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_09_NX-OS_SNMP_ACL"),$config);
...
$diff10 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_10_NX-OS_SNMP"),$config);
...
$diff11 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_11_NX-OS_SNMP_Identity"),$config);
...
$diff12 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_12_NX-OS_Banner"),$config);
$output12 = &pass_check($diff12);
$diff12 = &strip_comments($diff12);
print "$date,$timestamp,$file,NX-OS,12 - Banner,$output12$diff12\n";

# Policy 13 - NX-OS SSH
$diff13 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_13_NX-OS_SSH"),$config);
...
$diff14 .= &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_14_NX-OS_SNMPv3"),$config);
...
$diff15 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_15_NX-OS_Basic_Services"),$config);
$output15 = "PASS,";
$diff15 = &strip_comments($diff15);
print "$date,$timestamp,$file,NX-OS,15 - Basic Services,$output15$diff15\n";

# Policy 16 - NX-OS Boot System
$diff16 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_16_NX-OS_Boot_System"),$config);
$output16 = "PASS,";
$diff16 = &strip_comments($diff16);
print "$date,$timestamp,$file,NX-OS,16 - Boot System,$output16$diff16\n";

# Policy 17 - NX-OS RCMD
$diff17 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_17_NX-OS_RCMD"),$config);
$output17 = "PASS,";
$diff17 = &strip_comments($diff17);
print "$date,$timestamp,$file,NX-OS,17 - RCMD,$output17$diff17\n";

# Policy 18 - NX-OS Loopback
$diff18 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_18_NX-OS_Loopback"),$config);
...
$diff19 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_19_NX-OS_IP_Security"),$config);
...
$diff20 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_20_NX-OS_Source_Route"),$config);
$output20 ="PASS,";
$diff20 = &strip_comments($diff20);
print "$date,$timestamp,$file,NX-OS,20 - Source Route,$output20$diff20\n";

# Policy 21 - NX-OS SNMP Trap
$diff21 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_21_NX-OS_SNMP_TRAP"),$config);
$output21 ="PASS,";
...
$diff22 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_22_NX-OS_Interface_Description"),$config);
...
$diff23 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_23_NX-OS_CoPP"),$config);
...
$diff24 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_24_NX-OS_Logging"),$config);
...
$diff25 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_25_NX-OS_VTP"),$config);
$output25 ="PASS,";
...
$diff26 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_26_NX-OS_BPDUGuard"),$config);
$output26 ="PASS,";
...
$diff27 = &ios_config_global_lines(&open_file("$nxos_policy_dir/policy_27_NX-OS_BPDUGuard_Default"),$config);
$output27 ="PASS,";
