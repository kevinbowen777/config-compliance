...
my $policy_dir = "$dirname/../policies/ios";
...
$diff1 = &ios_config_global_lines(&open_file("$policy_dir/policy_01_IOS_AAA"),$config);
$output1 = &pass_check($diff1);
$diff1 = &strip_comments($diff1);
print "$date,$timestamp,$file,IOS,01 - AAA,$output1$diff1\n";

# Policy 02 - IOS TACACS
$diff2 = &ios_config_global_lines(&open_file("$policy_dir/policy_02_IOS_TACACS"),$config);
...
$diff3 = &ios_config_nested_lines(&open_file("$policy_dir/policy_03_IOS_Line_Console"),$config);
...
$diff4 = &ios_config_nested_lines(&open_file("$policy_dir/policy_04_IOS_Line_AUX"),$config);
...
$diff5 = &ios_config_nested_lines(&open_file("$policy_dir/policy_05_IOS_Line_VTY1"),$config);
...
$diff6 = &ios_config_global_lines(&open_file("$policy_dir/policy_06_IOS_Line_VTY2"),$config);
$output6 = &pass_check($diff6);
$diff6 = &strip_comments($diff6);
print "$date,$timestamp,$file,IOS,06 - Line VTY2,$output6$diff6\n";

# Policy 07 - IOS NTP
$diff7 = &ios_config_global_lines(&open_file("$policy_dir/policy_07_IOS_NTP"),$config);
$output7 ="PASS,";
$diff7 =~ tr{\n}{ };
...
# Policy 08 - IOS DNS
$diff8 = &ios_config_global_lines(&open_file("$policy_dir/policy_08_IOS_DNS"),$config);
...
$diff9 = &ios_config_global_lines(&open_file("$policy_dir/policy_09_IOS_SNMP_ACL"),$config);
...
$diff10 = &ios_config_global_lines(&open_file("$policy_dir/policy_10_IOS_SNMP"),$config);
...
$diff11 = &ios_config_global_lines(&open_file("$policy_dir/policy_11_IOS_SNMP_Identity"),$config);
...
$diff12 = &ios_config_global_lines(&open_file("$policy_dir/policy_12_IOS_Banner"),$config);
$output12 = &pass_check($diff12);
$diff12 = &strip_comments($diff12);
print "$date,$timestamp,$file,IOS,12 - Banner,$output12$diff12\n";

# Policy 13 - IOS SSH 
$diff13 = &ios_config_global_lines(&open_file("$policy_dir/policy_13_IOS_SSH"),$config);
...
if ($config =~ /switch 1 provision/i){
 $diff14 = &ios_config_global_lines(&open_file("$policy_dir/policy_14_IOS_VStack"),$config);
...
$diff15 = &ios_config_global_lines(&open_file("$policy_dir/policy_15_IOS_Basic_Services"),$config);
...
$diff16 = &ios_config_global_lines(&open_file("$policy_dir/policy_16_IOS_Boot_System"),$config);
$output16 = &pass_check($diff16);
$diff16 = &strip_comments($diff16);
print "$date,$timestamp,$file,IOS,16 - Boot System,$output16$diff16\n";

# Policy 17 - IOS RCMD
$diff17 = &ios_config_global_lines(&open_file("$policy_dir/policy_17_IOS_RCMD"),$config);
...
$diff23 = &ios_config_global_lines(&open_file("$policy_dir/policy_23_IOS_IP_Security"),$config);
...
$diff24 = &ios_config_global_lines(&open_file("$policy_dir/policy_24_IOS_Logging"),$config);
$output24 = &pass_check($diff24);
$diff24 = &strip_comments($diff24);
print "$date,$timestamp,$file,IOS,24 - LOGGING,$output24$diff24\n";

# Policy 25 -IOS VTP
$diff25 = &ios_config_global_lines(&open_file("$policy_dir/policy_25_IOS_VTP"),$config);
...
$diff26 = &ios_config_global_lines(&open_file("$policy_dir/policy_26_IOS_BPDUGuard"),$config);
...
$diff27 = &ios_config_global_lines(&open_file("$policy_dir/policy_27_IOS_BPDUGuard_Default"),$config);
