...
$diff1 = &ios_config_global_lines(&open_file("$policy_dir/policy_1-enterprise-ios_aaa_configuration.txt"),$config);
...
$diff2 = &ios_config_global_lines(&open_file("$policy_dir/policy_2-enterprise-ios_tacacs_configuration.txt"),$config);
...
$diff3 = &ios_config_nested_lines(&open_file("$policy_dir/policy_3-enterprise-ios_line_console_configuration.txt"),$config);
$output3 = &pass_check($diff3);
$diff3 = &strip_comments($diff3);
print "$date,$timestamp,$file,IOS,3 - CONSOLE,$output3$diff3\n";

# Policy 4 Line Aux
$diff4 = &ios_config_nested_lines(&open_file("$policy_dir/policy_4-enterprise-ios_line_aux_configuration.txt"),$config);
...
# Policy 5 VTY
$diff5 = &ios_config_nested_lines(&open_file("$policy_dir/policy_5a-enterprise-ios_line_vty_configuration.txt"),$config);
$diff5 .= &ios_config_nested_lines(&open_file("$policy_dir/policy_5b-enterprise-ios_line_vty_configuration.txt"),$config);
...
$diff6 = &ios_config_global_lines(&open_file("$policy_dir/policy_6-enterprise-ios_ntp_configuration.txt"),$config);
$output6 = &pass_check($diff6);
$diff6 = &strip_comments($diff6);
print "$date,$timestamp,$file,IOS,6 - NTP,$output6$diff6\n";

# Policy 7
#$diff7 = &ios_config_global_lines(&open_file("$policy_dir/policy7.txt"),$config);
#$output7 ="PASS,";
#$diff7 =~ tr{\n}{ };
...
# Policy 8 DNS
$diff8 = &ios_config_global_lines(&open_file("$policy_dir/policy_8-enterprise-ios_domain_name_services_configuration.txt"),$config);
...
$diff9 = &ios_config_global_lines(&open_file("$policy_dir/policy_9-enterprise-ios_snmp_acl_configuration.txt"),$config);
...
$diff10 = &ios_config_global_lines(&open_file("$policy_dir/policy_10-enterprise-ios_snmp_configuration.txt"),$config);
$output10 = &pass_check($diff10);
$diff10 = &strip_comments($diff10);
print "$date,$timestamp,$file,IOS,10 - SNMP,$output10$diff10\n";

# Policy 11 SNMP Identity information\n";
$diff11 = &ios_config_global_lines(&open_file("$policy_dir/policy_11-enterprise-ios_snmp_identity_configuration.txt"),$config);
...
$diff12 = &ios_config_global_lines(&open_file("$policy_dir/policy_12-enterprise-ios_banner_configuration.txt"),$config);
...
# $diff13 = &ios_config_global_lines(&open_file("$policy_dir/policy13a.txt"),$config);
# $diff13 .= &ios_config_nested_lines(&open_file("$policy_dir/policy13b.txt"),$config);
# $diff13 .= &ios_config_nested_lines(&open_file("$policy_dir/policy13c.txt"),$config);
...
if ($config =~ /switch 1 provision/i){
 $diff14 = &ios_config_global_lines(&open_file("$policy_dir/policy_14-enterprise-ios_disable_vstack_configuration.txt"),$config);
...
$diff15 = &ios_config_global_lines(&open_file("$policy_dir/policy_15-enterprise-ios_basic_services_configuration.txt"),$config);
...
$diff16 = &ios_config_global_lines(&open_file("$policy_dir/policy_16-enterprise-ios_boot_commands_configuration.txt"),$config);
$output16 = &pass_check($diff16);
$diff16 = &strip_comments($diff16);
print "$date,$timestamp,$file,IOS,16 - BOOT,$output16$diff16\n";

# Policy 17 RCMD
$diff17 = &ios_config_global_lines(&open_file("$policy_dir/policy_17-enterprise-ios_rcmd_configuration.txt"),$config);
...
if ($config =~ /interface Loopback0/im && $file !~ /-sw/){
 $diff18 = &ios_config_global_lines(&open_file("$policy_dir/policy_18-enterprise-ios_loopback_commands_configuration.txt"),$config);
...
$diff119 = &ios_config_all_interfaces(&open_file("$policy_dir/policy_19-enterprise-ios_interface_security_configuration.txt"),$config,@int_list);
...
$diff120 = &ios_config_all_interfaces(&open_file("$policy_dir/policy_20-enterprise-ios_rapid_acl_deployment_configuration.txt"),$config,@int_list);
$output20 ="PASS,";
$diff120 = &strip_comments($diff120);
print "$date,$timestamp,$file,IOS,20 - INTACL,$output20$diff20\n";

# Policy 21 Interface Logging
$diff121 = &ios_config_all_interfaces(&open_file("$policy_dir/policy_21-enterprise-ios_no_logging_event_no_snmp_trap_status_configuration.txt"),$config,@int_list);
$output21 ="PASS,";
$diff121 = &strip_comments($diff121);
print "$date,$timestamp,$file,IOS,21 - INTLOG,$output21$diff21\n";

# Policy 22 Interface Description
$diff122 = &ios_config_all_interfaces(&open_file("$policy_dir/policy_22-enterprise-ios_interface_description_configuration.txt"),$config,@int_list);
$output22 ="PASS,";
$diff122 = &strip_comments($diff122);
print "$date,$timestamp,$file,IOS,22 - DESCR,$output22$diff22\n";

# Policy 23 IP Security
$diff23 = &ios_config_global_lines(&open_file("$policy_dir/policy_23-enterprise-ios_ip_security_configuration.txt"),$config);
$output23 = &pass_check($diff23);
$diff23 = &strip_comments($diff23);
print "$date,$timestamp,$file,IOS,23 - SECURITY,$output23$diff23\n";

# Policy 24 Logging
$diff24 = &ios_config_global_lines(&open_file("$policy_dir/policy_24-enterprise-ios_configure_logging_configuration.txt"),$config);
$output24 = &pass_check($diff24);
$diff24 = &strip_comments($diff24);
print "$date,$timestamp,$file,IOS,24 - LOGGING,$output24$diff24\n";

# Policy 25 VTP
$diff25 = &ios_config_global_lines(&open_file("$policy_dir/policy_25-enterprise-ios_vtp_configuration.txt"),$config);
$output25 = &pass_check($diff25);
$diff25 = &strip_comments($diff25);
print "$date,$timestamp,$file,IOS,25 - VTP,$output25$diff25\n";

# Policy 26 BPDUGUARD
$diff26 = &ios_config_global_lines(&open_file("$policy_dir/policy_26-enterprise-ios_bpduguard_configuration.txt"),$config);
...
$diff27 = &ios_config_global_lines(&open_file("$policy_dir/policy_27-enterprise-ios_bpduguard_default_configuration.txt"),$config);
