...
#Policy 1 TACACS
$diff1 = &ios_config_global_lines(&open_file("$policy_dir/policy_1-enterprise-nx_aaa_configuration.txt"),$config);
...
$diff2 = &ios_config_global_lines(&open_file("$policy_dir/policy_2-enterprise-nx_tacacs_configuration.txt"),$config);
$output2 = &pass_check($diff2);
$diff2 = &strip_comments($diff2);
print "$date,$timestamp,$file,NXOS,2 - AAA,$output2$diff2\n";

#Policy 3 Management
$diff3 = &ios_config_nested_lines(&open_file("$policy_dir/policy_3-enterprise-nx_line_console_configuration.txt"),$config);
...
$diff4 = &ios_config_nested_lines(&open_file("$policy_dir/policy_4-enterprise-nx_line_aux_configuration.txt"),$config);
$output4 = &pass_check($diff4);
$diff4 = &strip_comments($diff4);
print "$date,$timestamp,$file,NXOS,4 - MGMT Routing,$output4$diff4\n";

#Policy 5 NTP
$diff5 = &ios_config_global_lines(&open_file("$policy_dir/policy_5-enterprise-nx_line_vty_configuration.txt"),$config);
$output5 = &pass_check($diff5);
$diff5 = &strip_comments($diff5);
print "$date,$timestamp,$file,NXOS,5 - NTP,$output5$diff5\n";

#Policy 7 DNS
$diff7 = &ios_config_global_lines(&open_file("$policy_dir/policy_7-enterprise-nx_ntp_configuration_stratum2_configuration.txt"),$config);
...
$diff8 = &ios_config_global_lines(&open_file("$policy_dir/policy_8-enterprise-nx_domain_name_services_configuration.txt"),$config);
...
$diff9 = &ios_config_global_lines(&open_file("$policy_dir/policy_9-enterprise-nx_snmp_acl_configuration.txt"),$config);
...
$diff10 = &ios_config_global_lines(&open_file("$policy_dir/policy_10-enterprise-nx_snmp_configuration.txt"),$config);
$output10 = &pass_check($diff10);
$diff10 = &strip_comments($diff10);
print "$date,$timestamp,$file,NXOS,10 - IDENTITY,$output10$diff10\n";

#Policy 11 Banner
$diff11 = &ios_config_global_lines(&open_file("$policy_dir/policy_11-enterprise-nx_snmp_identity_configuration.txt"),$config);
$output11 = &pass_check($diff11);
$diff11 = &strip_comments($diff11);
print "$date,$timestamp,$file,NXOS,11 - BANNER,$output11$diff11\n";

#Policy 12 SSH
$diff12 = &ios_config_global_lines(&open_file("$policy_dir/policy_12-enterprise-nx_banner_configuration.txt"),$config);
...
$diff13 = &ios_config_global_lines(&open_file("$policy_dir/policy_13-enterprise-nx_ssh_configuration.txt"),$config);
...
# $diff14 = &ios_config_nested_lines(&open_file("$policy_dir/policy14a.txt"),$config);
# $diff14 .= &ios_config_global_lines(&open_file("$policy_dir/policy14b.txt"),$config);
...
$diff15 = &ios_config_global_lines(&open_file("$policy_dir/policy_15-enterprise-nx_basic_services_configuration.txt"),$config);
$output15 = "PASS,";
$diff15 = &strip_comments($diff15);
print "$date,$timestamp,$file,NXOS,15 - INT SEC,$output15$diff15\n";

#Policy 16 Rapid ACL
$diff16 = &ios_config_global_lines(&open_file("$policy_dir/policy_16-enterprise-nx_boot_commands_configuration.txt"),$config);
$output16 = "PASS,";
$diff16 = &strip_comments($diff16);
print "$date,$timestamp,$file,NXOS,16 - RAPID ACL,$output16$diff16\n";

#Policy 17 SNMP Logging
$diff17 = &ios_config_global_lines(&open_file("$policy_dir/policy_17-enterprise-nx_rcmd_configuration.txt"),$config);
$output17 = "PASS,";
$diff17 = &strip_comments($diff17);
print "$date,$timestamp,$file,NXOS,17 - SNMP LOG,$output17$diff17\n";

## Policy 18 Interface Description
$diff18 = &ios_config_global_lines(&open_file("$policy_dir/policy_18-enterprise-nx_loopback_commands_configuration.txt"),$config);
$output18 = "PASS,";
$diff18 = &strip_comments($diff18);
print "$date,$timestamp,$file,NXOS,18 - INT DESCR,$output18$diff18\n";

## Policy 19 Interface Security
$diff19 = &ios_config_all_interfaces(&open_file("$policy_dir/policy_19-enterprise-nx_ip_security_configuration.txt"),$config,@int_list);
...
$diff20 = &ios_config_all_interfaces(&open_file("$policy_dir/policy_20-enterprise-nx_rapid_acl_deployment_configuration.txt"),$config,@int_list);
$output20 ="PASS,";
$diff20 = &strip_comments($diff20);
print "$date,$timestamp,$file,NXOS,20 - IP SEC,$output20$diff20\n";

## Policy 21 Logging
$diff21 = &ios_config_all_interfaces(&open_file("$policy_dir/policy_21-enterprise-nx_no_logging_event_no_snmp_trap_status_configuration.txt"),$config,@int_list);
$output21 ="PASS,";
$diff21 = &strip_comments($diff21);
print "$date,$timestamp,$file,NXOS,21 - LOGGING,$output21$diff21\n";

# Policy 22 Line Console
# $diff22 = &ios_config_nested_lines(&open_file("$policy_dir/policy_22-enterprise-nx_interface_description_configuration.txt"),$config);
# $output22 = &pass_check($diff22);
# $diff22 = &strip_comments($diff22);
# print "$date,$timestamp,$file,NXOS,22 - CONSOLE,$output22$diff22\n";

# Policy 23 Line VTY
# $diff23 = &ios_config_global_lines(&open_file("$policy_dir/policy23a.txt"),$config);
# $diff23 .= &ios_config_nested_lines(&open_file("$policy_dir/policy23b.txt"),$config);
...
# $diff24 = &ios_config_acls(&open_file("$policy_dir/policy26.txt"),$config);
# $output24 = &pass_check($diff24);
# $diff24 = &strip_comments($diff24);
# print "$date,$timestamp,$file,NXOS,24 - COPP,$output24$diff24\n";

# Policy 25 Logging
# $diff25 = &ios_config_all_interfaces(&open_file("$policy_dir/policy25.txt"),$config,@int_list);
# $output25 ="PASS,";
# $diff25 = &strip_comments($diff25);
# print "$date,$timestamp,$file,NXOS,25 - MULTICAST,$output25$diff25\n";

# Policy 27 BPDUGUARD
# $diff27 = &ios_config_all_interfaces(&open_file("$policy_dir/policy_27-enterprise-nxos_bpduguard_configuration.txt"),$config,@int_list);
# $output27 ="PASS,";
